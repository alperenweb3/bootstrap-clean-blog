...
function Home() {
  return (
    <>
      <Header title="Clean Blog" description="A Blog Theme by Start Bootstrap" img="home"/>
  ...
  <div className="row gx-4 gx-lg-5 justify-content-center">
    <div className="col-md-10 col-lg-8 col-xl-7">
      ...
      {/* Post preview*/}
      <div className="post-preview">
        <a href="#"><h2 className="post-title">I believe every human has a finite number of heartbeats. I don't intend to waste any of mine.</h2></a>
        <p className="post-meta">
          Posted by
          <a href="#!">Start Bootstrap</a>
